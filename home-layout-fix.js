...
(function(){
  ...
  style.textContent=`
    ...
    #homeScreen .home-hero{min-height:210px;max-height:none;flex:none;background-image:url('assets/home-hero-v4.jpg?v=4');background-position:center center;background-size:cover}
