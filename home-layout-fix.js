...
(function(){
  ...
  style.textContent=`
    ...
    #homeScreen .home-hero{min-height:210px;max-height:none;flex:none;background-image:url('assets/home-hero-v3.jpg?v=3');background-position:center center;background-size:cover}
